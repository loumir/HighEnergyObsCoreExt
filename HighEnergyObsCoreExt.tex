...
\hline
 ev\_xel & \ucd{meta.number;instr.detection} &  unitless & int & {Number of events in an {\bf he-event-list}}& NO \\
\hline
...
\hline
  event\_type & \ucd{meta.code.qual;instr.detection} & unitless & string &{Data quality flag of the events ({\em e.g.\/}, ``good psf'', ``good rejection'', ``Nhit (100,200)''} & NO \\
\hline
